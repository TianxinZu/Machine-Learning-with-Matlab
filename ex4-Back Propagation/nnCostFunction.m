...
for i = 1 : m
    ...
    z3 = Theta2 * [1; a2];
    a3 = sigmoid(z3);
    J = J - labels(:, y(i))' * log(a3) - (1 - labels(:, y(i)))' * log(1 - a3);
    
    delta3 = a3 - labels(:, y(i));
...
Theta1_grad(:, 2 : end) = Delta1(:, 2 : end) / m + ...
                          lambda * Theta1(:, 2 : end) / m;
Theta2_grad(:, 1) = Delta2(:, 1) / m;
Theta2_grad(:, 2 : end) = Delta2(:, 2 : end) / m + ...
                          lambda * Theta2(:, 2 : end) / m;
